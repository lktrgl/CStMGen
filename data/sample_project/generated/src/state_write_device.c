...
/* %{SENS_COMM_WRITE_DEVICE-GLOBAL-DATA-DECLARATION-AND-CODE-DEFINITION}% */
...
static void s_enter_write_device ( void* data )
{
  ...
  /* %{SENS_COMM_WRITE_DEVICE-ENTER-USER-IMPLEMENTATION}% */
...
static void s_input_write_device ( void* data )
{
  ...
  /* %{SENS_COMM_WRITE_DEVICE-INPUT-USER-IMPLEMENTATION}% */
...
static void s_run_write_device ( void* data )
{
  ...
  /* %{SENS_COMM_WRITE_DEVICE-RUN-USER-IMPLEMENTATION}% */
...
static void s_output_write_device ( void* data )
{
  ...
  /* %{SENS_COMM_WRITE_DEVICE-OUTPUT-USER-IMPLEMENTATION}% */
...
static void s_leave_write_device ( void* data )
{
  ...
  /* %{SENS_COMM_WRITE_DEVICE-LEAVE-USER-IMPLEMENTATION}% */
